  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.pexels.com/photos/7097/people-coffee-tea-meeting.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')",
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-4">
            <div className="flex items-center">
              ...
              <div className="ml-2 text-white">
                <span className="font-bold text-blue-400 text-lg">{stats.engineersJoined} engineers</span> already joined!
              </div>
            </div>
