      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            <a href={social.linkedin} className="p-2 bg-slate-800 rounded-full hover:bg-blue-600 transition-colors">
              <Linkedin size={20} />
            </a>
            <a href={social.twitter} className="p-2 bg-slate-800 rounded-full hover:bg-blue-600 transition-colors">
              <Twitter size={20} />
            </a>
            <a href={social.youtube} className="p-2 bg-slate-800 rounded-full hover:bg-blue-600 transition-colors">
              <Youtube size={20} />
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a href={link.href} className="text-slate-300 hover:text-white">{link.title}</a>
                  </li>
                ))}
              </ul>
            </div>
